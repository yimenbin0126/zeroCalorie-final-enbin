...
- 기술 스택 : Spring, Java, JSP, Ajax, Javascript, 외부라이브러리(jQuery), DBMS(Oracle), CSS
...
- '고객센터' 주제의 CRUD 게시판
- 관리자용/회원모두용 게시판 CRUD, 게시판 답글, 좋아요/싫어요
- 조회수, 검색, 페이징, 파일 첨부기능, 댓글/대댓글 구현
...
<br>
<img width="900" alt="(5) 고객센터 - 상세보기 댓글" src="https://user-images.githubusercontent.com/93369732/198494665-fb1c78e4-90f9-4e49-9608-b8caed4624d6.png">
